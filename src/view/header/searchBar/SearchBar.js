    ...
    return (
        <div>
            <div className={searchResult.length === 0 ? 'search-bar-closed' : 'search-bar-opened'}>
                ...
                <input className='input-style' value={searchText} onChange={(e) => {
...

                {
                    searchText.length !== 0 && (
                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 49 49" fill="none" onClick={() => {
                            ...
                            <path d="M6.12457 6.12457L42.8754 42.8754M6.12457 42.8754L42.8754 6.12457" stroke="#001F3F" stroke-width="4" stroke-linecap="round" />
                        </svg>
