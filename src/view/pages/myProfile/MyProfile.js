...
const methods=useSelector((state)=>state.methodsStore.paymentMethods);
...
const dispatch=useDispatch();
    ...
    const handleAddCard=()=>{
        axios.post("http://localhost:6005/paymentmethod/add",{
            ...
            dispatch(addPaymentMethod(res.data.method))
            toast({
                title: "Added Payement Method!",
                status: "success",
                duration: 5000,
                isClosable: true,
                position: "bottom",
            ...
            if(e.response.status){
                toast({
                    title: "Payement Method Already Exists!",
                    status: "error",
                    duration: 5000,
                    isClosable: true,
                    position: "bottom",
                ...
                <div style={{ width: "80%", display: "flex", justifyContent: "space-around" }}>
                    {
                        !switchWindow ? <>
                            ...
                            <div style={{ width: "45%" }}>
                                ...
                                {isLawyer&&<FormControl isInvalid={isError} isRequired>
                                ...
                                <div style={{ display: "flex", width: "100%",justifyContent:"center" }}>
                                    ...
                                    <div className="form-container">
                                        <div className="field-container">
                                            ...
                                            <input id="name" maxlength="20" type="text" value={cardHolder} onFocus={() => {
                                                setFlipped(false);
                                            }} onChange={(e) => {
                                        ...
                                        <div className="field-container">
                                            ...
                                            <input id="securitycode" type="text" pattern="[0-9]*" inputmode="numeric" onFocus={() => {
                                                setFlipped(true);
                                            }} value={ccv2} onChange={handleCcv2Change}></input>
                                        </div>
                                    </div>
