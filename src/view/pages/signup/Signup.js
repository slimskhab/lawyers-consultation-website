            ...
            <div style={{ padding: "50px", display: "flex", flexDirection: "column", alignItems: "center", width: "100%" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-around", width: "100%" }}>
                    <div style={{ display: "flex", flexDirection: "column", justifyContent: "start", alignItems: "start", width: "100%" }}>
                        ...
                        <div className='input-box'>
                            <input className='input-style' placeholder='' ref={firstNameRef}></input>
                    ...
                    <div style={{ display: "flex", marginLeft: "100px", flexDirection: "column", justifyContent: "start", alignItems: "start", width: "100%" }}>
                        ...
                        <div className='input-box'>
                            <input className='input-style' placeholder='' ref={lastNameRef}></input>
                    ...
                    isSelected && (
                        <div style={{ display: "flex", flexDirection: "column", justifyContent: "start", alignItems: "start", width: "100%" }}>
                            ...
                            <div className='input-box' style={{ height: "195px", padding: 10 }}>
                                <textarea className='input-style' placeholder='' rows='5' style={{ resize: "none" }} ref={bioRef}></textarea >
                ...
                <br></br>
                {
                    isSelected && (<div style={{ width: "100%", display: "flex", flexDirection: "column" }}>
                        ...
                        <div className="degree-container" style={{ alignSelf: "center" }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="71" height="71" viewBox="0 0 71 71" fill="none">
                                <path d="M47.3332 47.3333L35.4998 35.5L23.6665 47.3333" stroke="black" stroke-opacity="0.4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M35.5 35.5V62.125" stroke="#003C73" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M60.3202 54.4038C63.2056 52.8308 65.485 50.3417 66.7986 47.3293C68.1122 44.317 68.3853 40.9529 67.5747 37.7682C66.7641 34.5834 64.916 31.7593 62.3221 29.7415C59.7281 27.7237 56.5361 26.6272 53.2498 26.6251H49.5223C48.6269 23.1616 46.9579 19.9461 44.6409 17.2205C42.3239 14.4949 39.4192 12.3299 36.145 10.8885C32.8709 9.44709 29.3126 8.76666 25.7377 8.89837C22.1627 9.03009 18.6641 9.97053 15.505 11.649C12.3458 13.3274 9.60822 15.7002 7.49808 18.589C5.38793 21.4777 3.96011 24.8073 3.32197 28.3273C2.68383 31.8473 2.85197 35.4661 3.81374 38.9118C4.77552 42.3574 6.50591 45.5402 8.87482 48.2209" stroke="#003C73" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M47.3332 47.3333L35.4998 35.5L23.6665 47.3333" stroke="#003C73" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                            <div style={{ display: "flex", flexDirection: "column", alignItems: "start" }}>
                                <p className='select-file-text'>Select a file or drag and drop here</p>
